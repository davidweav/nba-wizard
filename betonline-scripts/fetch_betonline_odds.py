import odds_api.get_nba_events as nbaE
import odds_api.get_nhl_events as nhlE
import odds_api.get_nba_pp as nbaPP
import odds_api.get_nhl_pp as nhlPP
...
for api_key in api_keys:
    if nhlE.fetch_nhl_events(api_key):
        current_api_key = api_key
        break
